...
namespace Application.Repository
{
    public class ReservationRepository : IReservationRepository
    {
        ...
        public async Task<Reservation> GetReservationWithOccupied(Guid id)
        {
            return await _dbContext.Reservation.Include(m => m.OccupiedRoom).FirstOrDefaultAsync(m => m.Id == id);
        }
        ...
        public async Task AddReservation(Reservation reservation)
        {
            ...
            reservation.OccupiedRoom = new OccupiedRoom();
            reservation.OccupiedRoom.CustomerId = reservation.CustomerId;
            reservation.OccupiedRoom.RoomId = reservation.RoomId;
        ...
        {
            var reservation = await _dbContext.Set<Reservation>().Include(m => m.OccupiedRoom)
                                                          .FirstOrDefaultAsync(m => m.Id == id);
            if (reservation != null)
            {
                _dbContext.OccupiedRoom.Remove(reservation.OccupiedRoom);
